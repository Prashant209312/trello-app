...
const MarketingPage = () => {
  return (
    <div className="flex items-center justify-center flex-col">
      ...
      >
        <div className="mb-4 flex items-center border shadow-sm bg-amber-100 text-amber-700  p-4 rounded-full uppercase">
      ...
      <div
        className={cn(
          "text-sm md:text-xl text-neutral-400 mt-4 max-w-xs text-center md:max-w-2xl mx-auto ",
          textFont.className
        )}
      >
